...
| 案例 | 周期 | 期望 | 多周期行为 |
|---|---|---|---|
| C1 黄金 | 1D 08-04 | 应出 | plateau {3,4} 宽2 ✓ → 行含 1D |
| C2 黄金 | 1D 08-03 | 应出 | plateau {3,4} 宽2 ✓ → 行含 1D |
| C3 ONUSDT | 4H | 应出 | plateau {3,4,5} 宽3 ✓ → 行含 4H |
| C4 HYPE | 4H now | 不应出 | plateau 0 → 行不出现 ✓ |
| C5 HYPE | 15m@锚 1H@锚 | 应出 | 15m lt≈1.1 拒;1H plateau {3,4} 宽2 ✓ → 行含 1H(收敛周期=1H)✓ |
